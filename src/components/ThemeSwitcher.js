...
export default function ThemeSwitcher(){
    ...
    return(
        <>
            <button onClick={handleClick} className="hidden dark:flex p-4 hover:text-sky-500">
                <svg class="fill-current hover:fill-cyan-500 size-7" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button onClick={handleClick} className="flex dark:hidden p-4 hover:text-sky-500">
            <svg class="stroke-current hover:stroke-cyan-500 size-7" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
